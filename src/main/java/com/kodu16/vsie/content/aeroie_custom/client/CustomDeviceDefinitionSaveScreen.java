...
final class CustomDeviceDefinitionSaveScreen extends CrispScreen {
    ...
    CustomDeviceDefinitionSaveScreen(Screen parent, String initialName, BiConsumer<String, String> onSave) {
