...
public final class CustomTurretAnchor {
    private CustomTurretAnchor() {
    }

    public static float[] rootPivotOffset(CustomTurretDefinition definition) {
    ...
    public static float[] rootPivotWorldPosition(int blockX, int blockY, int blockZ,
                                                  CustomTurretDefinition definition) {
    ...
    private static float[] rootAnchor(CustomTurretDefinition definition) {
