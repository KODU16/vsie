...
public final class CustomTurretFirepointTransform {
    ...
    public static float[] localFirepoint(CustomTurretDefinition definition, int index,
                                         float pitchRadians, float yawRadians) {
        CustomTurretDefinition.Bone firepoint = definition.findBone("firepoint" + index);
        if (firepoint == null) {
    ...
    private static Matrix4f parentTransform(CustomTurretDefinition definition, CustomTurretDefinition.Bone bone,
                                            float pitchRadians, float yawRadians) {
