...
final class CustomTurretAssetPackageScreen extends CrispScreen {
    ...
    private final Consumer<CustomTurretAssetPackage> onSelected;
    private final Screen parent;
    private List<CustomTurretAssetPackage> packages = List.of();
    ...
    CustomTurretAssetPackageScreen(Consumer<CustomTurretAssetPackage> onSelected, Screen parent) {
    ...
    @Override
    protected void init() {
        packages = CustomTurretStorage.scanAssetPackages();
