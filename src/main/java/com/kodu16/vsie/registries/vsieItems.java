...
import com.kodu16.vsie.content.aeroie_custom.export.RegionObjExportToolItem;
...
public class vsieItems {
    ...
    // Function: authoring is command-only; this reusable item selects and places any AeroIE custom definition.
    public static final ItemEntry<CustomDevicePlacerItem> CUSTOM_DEVICE_PLACER =
            REGISTRATE.item("custom_turret_placer", CustomDevicePlacerItem::new).register();
